...
public class DSplitScript : MonoBehaviour
{
   ...
   private void SwitchD(){
   	if (state == 1) {
             ...
             D2.transform.GetChild(0).GetComponentInChildren<PlayerController>().enabled = false;
         ...
         if (state == 2) {
             ...
             D1.transform.GetChild(0).GetComponentInChildren<PlayerController>().enabled = false;
     ...
     private void D1DimensionController()
     {
         ...
         D1.transform.GetChild(0).GetComponentInChildren<PlayerController>().enabled = true;
         // Enables Controller2D script in parent of PlayerGameObj Mesh 
         PlayerGameObj.GetComponentInParent<PlayerPhysics>().enabled = true;
     ...
     private void D2DimensionController()
     {
         ...
         D2.transform.GetChild(0).GetComponentInChildren<PlayerController>().enabled = true;
         // Enables Controller2D script of PlayerGameObj2  
         PlayerGameObj2.GetComponent<PlayerPhysics>().enabled = true;
         // Transforms players layer to Player in scene
